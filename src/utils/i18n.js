...
const TRANSLATION_KEYS = [
  ...
  'unsaved_changes_category_title',
  'unsaved_changes_category_msg',
  'unsaved_changes_category_detail',
  'abandon',
  'stay',
...
const FALLBACK_TRANSLATIONS = {
  fr: {
    ...
    unsaved_changes_category_title: 'Modifications de catégorie non enregistrées',
    unsaved_changes_category_msg: 'Voulez-vous abandonner les modifications de cette catégorie ?',
    unsaved_changes_category_detail:
      'Si vous quittez, les modifications apportées à la catégorie seront perdues.',
    abandon: 'Abandonner',
    stay: 'Rester',
    ...
    most_sold_today: "Article le plus vendu aujourd'hui",
    most_growth_month: 'Plus forte progression du mois',
    growth: 'Progression',
    ...
    read_only_basket: 'Ticket de caisse (Lecture seule)',
  ...
  en: {
    ...
    unsaved_changes_category_title: 'Unsaved Category Changes',
    unsaved_changes_category_msg: 'Do you want to discard changes to this category?',
    unsaved_changes_category_detail: 'If you leave, your changes to this category will be lost.',
    abandon: 'Discard',
    stay: 'Stay',
    ...
    most_sold_today: 'Most sold item today',
    most_growth_month: 'Highest growth this month',
    growth: 'Growth',
    no_data: 'No data',
    client: 'Client',
    date: 'Date',
    ...
    read_only_basket: 'Receipt (Read-only)',
